    ...
    <div class="animate-fade-in">
      ...
      <div class="card-grid">
        ...
        <div 
          ...
          <h3 class="card-title" style="position: relative; z-index: 10;">Information Protection</h3>
          <p class="card-desc" style="position: relative; z-index: 10;">Entrena y administra Microsoft Purview Information Protection Administrator (SC-400).</p>

          <div class="card-footer" style="position: relative; z-index: 10;">
            <span class="text-muted">~ 400 Preguntas</span>
